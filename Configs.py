...
_C.MODEL.INPUT = CN()
_C.MODEL.INPUT.IMAGE_SIZE = 608 # 模型输入尺寸
...
_C.TRAIN.BATCH_SIZE = 6        # 训练批次, 如果内存小，可以调小。如果使用多块gpu，请使用整数倍gpu数量的批次数
...
_C.DATA.DATASET.DATA_DIR = '/home/super/VOC_det/VOCdevkit/VOC2007'   # 数据集voc格式,根目录   请更改为自己的目录
...
_C.STEP = CN()
_C.STEP.VIS_STEP = 100          # visdom可视化训练过程,打印步长
